...
void avenger::EventMetadata::registerListener(avenger::EventListener *listener) {
    listeners_.push_back(listener);
}

void avenger::EventMetadata::notifyListeners(std::shared_ptr<avenger::Event> event) {
