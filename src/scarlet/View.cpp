...
void avenger::scarlet::View::setLayoutParams(
    std::unique_ptr<avenger::scarlet::LayoutParams> params) {
...
std::unique_ptr<avenger::scarlet::LayoutParams>
avenger::scarlet::LayoutParams::MakeSkRect(const SkRect& rect) {
  std::unique_ptr<LayoutParams> params =
      std::make_unique<avenger::scarlet::LayoutParams>();
  params->setBounds(rect);
}

std::unique_ptr<avenger::scarlet::LayoutParams>
avenger::scarlet::LayoutParams::MakeDefault() {
