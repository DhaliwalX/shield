...
avenger::strange::TCPConnection::pointer avenger::strange::TCPConnection::Create(avenger::strange::IOService &service) {
    return std::make_shared<avenger::strange::TCPConnection>(service.getService());
}
...
void avenger::strange::TCPConnection::handleWrite(const boost::system::error_code &ec, size_t transfered) {
